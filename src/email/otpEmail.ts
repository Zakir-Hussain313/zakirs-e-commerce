export const otpEmail = (otp: string): string => {
    const html = `
<!DOCTYPE html>
								...
								<tr>
									<td style="padding:15px 0 20px 0;">
										...
										<div style="text-align:center; margin:20px 0;">
											<h1 style="color:#7747FF; font-size:38px; font-weight:700; margin:0;">${otp}</h1>
										</div>
										<p style="text-align:center; font-size:13px; color:#393d47;">
											<strong>Note:</strong> This OTP is valid for 10 minutes. Do not share it with anyone.<br/>
