...
const Filter = () => {
  ...
  const { data: colorData } = useFetch('/api/varient/colors');
  const { data: sizeData } = useFetch('/api/varient/sizes');
    ...
    <div>
      ...
      <Accordion type="multiple" defaultValue={['1', '2', '3', '4']}>
        ...
        <AccordionItem value="4">
          ...
          <AccordionContent>
            < Slider defaultValue={[0, 3000]} max={3000} step={1} className='mt-3' onValueChange={handlePriceChange} />
            <div className='flex justify-between items-center pt-2'>
              <span>
                {
                  priceFilter.minPrice.toLocaleString('en-PK', { style: 'currency', currency: 'PKR' })
                }
              </span>
              <span>
                {
                  priceFilter.maxPrice.toLocaleString('en-PK', { style: 'currency', currency: 'PKR' })
                }
              </span>
            </div>
            <div className='mt-4'>
